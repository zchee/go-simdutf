...
func TestImplementationTableExactFields(t *testing.T) {
	...
	want := []struct {
		...
		{name: "utf8LengthFromLatin1", typ: reflect.TypeFor[func([]byte) int]()},
		...
		{name: "convertLatin1ToUTF8", typ: reflect.TypeFor[func([]byte, []byte) int]()},
		...
		{name: "convertUTF16LEToLatin1", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		{name: "convertUTF16BEToLatin1", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		{name: "convertUTF16LEToLatin1WithErrors", typ: reflect.TypeFor[func([]uint16, []byte) Result]()},
		{name: "convertUTF16BEToLatin1WithErrors", typ: reflect.TypeFor[func([]uint16, []byte) Result]()},
		{name: "convertValidUTF16LEToLatin1", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		{name: "convertValidUTF16BEToLatin1", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		{name: "convertUTF16LEToUTF32", typ: reflect.TypeFor[func([]uint16, []uint32) int]()},
		{name: "convertUTF16BEToUTF32", typ: reflect.TypeFor[func([]uint16, []uint32) int]()},
		{name: "convertUTF16LEToUTF32WithErrors", typ: reflect.TypeFor[func([]uint16, []uint32) Result]()},
		{name: "convertUTF16BEToUTF32WithErrors", typ: reflect.TypeFor[func([]uint16, []uint32) Result]()},
		{name: "convertValidUTF16LEToUTF32", typ: reflect.TypeFor[func([]uint16, []uint32) int]()},
		{name: "convertValidUTF16BEToUTF32", typ: reflect.TypeFor[func([]uint16, []uint32) int]()},
		{name: "utf32LengthFromUTF16LE", typ: reflect.TypeFor[func([]uint16) int]()},
		{name: "utf32LengthFromUTF16BE", typ: reflect.TypeFor[func([]uint16) int]()},
		{name: "convertUTF16LEToUTF8", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		{name: "convertUTF16BEToUTF8", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		{name: "convertUTF16LEToUTF8WithErrors", typ: reflect.TypeFor[func([]uint16, []byte) Result]()},
		{name: "convertUTF16BEToUTF8WithErrors", typ: reflect.TypeFor[func([]uint16, []byte) Result]()},
		{name: "convertUTF16LEToUTF8WithReplacement", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		{name: "convertUTF16BEToUTF8WithReplacement", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		{name: "convertValidUTF16LEToUTF8", typ: reflect.TypeFor[func([]uint16, []byte) int]()},
		...
		{name: "convertUTF32ToLatin1", typ: reflect.TypeFor[func([]uint32, []byte) int]()},
		{name: "convertUTF32ToLatin1WithErrors", typ: reflect.TypeFor[func([]uint32, []byte) Result]()},
		{name: "convertValidUTF32ToLatin1", typ: reflect.TypeFor[func([]uint32, []byte) int]()},
		{name: "convertUTF32ToUTF8", typ: reflect.TypeFor[func([]uint32, []byte) int]()},
		{name: "convertUTF32ToUTF8WithErrors", typ: reflect.TypeFor[func([]uint32, []byte) Result]()},
		{name: "convertValidUTF32ToUTF8", typ: reflect.TypeFor[func([]uint32, []byte) int]()},
		{name: "convertUTF32ToUTF16LE", typ: reflect.TypeFor[func([]uint32, []uint16) int]()},
		{name: "convertUTF32ToUTF16BE", typ: reflect.TypeFor[func([]uint32, []uint16) int]()},
		{name: "convertUTF32ToUTF16LEWithErrors", typ: reflect.TypeFor[func([]uint32, []uint16) Result]()},
		{name: "convertUTF32ToUTF16BEWithErrors", typ: reflect.TypeFor[func([]uint32, []uint16) Result]()},
		{name: "convertValidUTF32ToUTF16LE", typ: reflect.TypeFor[func([]uint32, []uint16) int]()},
		{name: "convertValidUTF32ToUTF16BE", typ: reflect.TypeFor[func([]uint32, []uint16) int]()},
		{name: "utf8LengthFromUTF32", typ: reflect.TypeFor[func([]uint32) int]()},
		{name: "utf16LengthFromUTF32", typ: reflect.TypeFor[func([]uint32) int]()},
	}
