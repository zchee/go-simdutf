...
- commit: [`dec3aad192f47081110d9c766d4917bad243906f`](https://github.com/simdutf/simdutf/tree/dec3aad192f47081110d9c766d4917bad243906f)
- tree: `eb5429bb160dfdf1a7d208f0184d3379940e69ee`
- detached local checkout: `/var/folders/dp/89wwdp754235m6jmdzj7p5lm0000gn/T/go-simdutf-upstream.ynLkUM/simdutf`

Before using an upstream source, run and record these exact commands:

```sh
UP=/var/folders/dp/89wwdp754235m6jmdzj7p5lm0000gn/T/go-simdutf-upstream.ynLkUM/simdutf
...
Phase-0 evidence recorded on 2026-07-26 UTC: the first command printed
`dec3aad192f47081110d9c766d4917bad243906f` and
`eb5429bb160dfdf1a7d208f0184d3379940e69ee`; every cleanliness check exited
zero; and `origin` was `https://github.com/simdutf/simdutf.git`. A failure is
a hard blocker: recreate or repair the pinned checkout and repeat the commands.
No moving branch, later tag, later commit, blog post, competing implementation,
or generated output can fill a semantic or algorithm gap.
...
[`LICENSE-APACHE`](https://github.com/simdutf/simdutf/blob/dec3aad192f47081110d9c766d4917bad243906f/LICENSE-APACHE),
[`LICENSE-MIT`](https://github.com/simdutf/simdutf/blob/dec3aad192f47081110d9c766d4917bad243906f/LICENSE-MIT),
and [README license statement](https://github.com/simdutf/simdutf/blob/dec3aad192f47081110d9c766d4917bad243906f/README.md#L3020-L3024).
