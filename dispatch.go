...
type implementation struct {
	...
	utf32LengthFromUTF16LE               func([]uint16) int
	utf32LengthFromUTF16BE               func([]uint16) int
	convertUTF16LEToUTF8                 func([]uint16, []byte) int
	convertUTF16BEToUTF8                 func([]uint16, []byte) int
	convertUTF16LEToUTF8WithErrors       func([]uint16, []byte) Result
	convertUTF16BEToUTF8WithErrors       func([]uint16, []byte) Result
	convertUTF16LEToUTF8WithReplacement  func([]uint16, []byte) int
	convertUTF16BEToUTF8WithReplacement  func([]uint16, []byte) int
	convertValidUTF16LEToUTF8            func([]uint16, []byte) int
	convertValidUTF16BEToUTF8            func([]uint16, []byte) int
	utf8LengthFromUTF16LE                func([]uint16) int
	utf8LengthFromUTF16BE                func([]uint16) int
	countUTF16LE                         func([]uint16) int
	countUTF16BE                         func([]uint16) int
