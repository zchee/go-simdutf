...
// The independently optional Find backends exist only in amd64 experiment
// builds; this is not an algorithm translation.

func archsimdFind() func([]byte, byte) int { return nil }

func archsimdFindUTF16() func([]uint16, uint16) int { return nil }
